    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-6 text-center">
          <div className="text-2xl font-bold tracking-tight">Mini Recruitment</div>
          <div className="mt-1 text-sm text-slate-600">Dashboard demo (dummy auth)</div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-md p-6">
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div className="text-xs text-slate-500 leading-relaxed">
              Demo account: <span className="font-medium">admin@example.com</span> / <span className="font-medium">password123</span>
            </div>
          </form>
        </div>
      </div>
